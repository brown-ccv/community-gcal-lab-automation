...
Provide a command-line interface for lab administrators to interactively input participant details, validate inputs, schedule follow-ups, and report execution results.
